...
enum State { INIT, VAN_READY, RAMP_READY, ALL_READY, STOP, START_EXCHANGE, POSSITION_PACK, RAISE_LIFT, LOWER_LIFT, ACTUATORS_OUT, ACTUATORS_IN, COMPLETE, CHECK_BATTERIES, MOVE_BAT_TO_CHARGER, INIT_CHARGERS};
State autoState = INIT;
bool actuatorPossition = true;
  ...
  while (autoState != STOP)
  {
    ...
    switch (autoState)
    {
      ...
      case RAISE_LIFT:
        {
          raiseLift();
          if (actuatorPossition)
          {
            actuatorPossition = false;
